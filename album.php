        ...
        <div class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 width">
                        <div class="address">
                            ...
                            <ul class="locarion_icon">
                                <li><img src="icon/1.png" alt="icon" />Immunity Spot LLP,<br> Plot No.62, Ward No.25, Veerana Gouda Colony Near Triangle Park, Infantry Road, BALLARI - 583104.
                                </li>
                    ...
                    <div class="col-lg-8 col-md-6 col-sm-12 width disabled_in_mobile_view">
                        <div class="address">
                            <h3>Get In Touch</h3>
